...
namespace MBaske.Sensors.Audio
{
    ...
    public class AudioSensorComponent : SensorComponent, IAudioSampler, IDisposable, IMeasurable
    {
        ...
        {
            return new List<string>{"BufferLength", "BufferPosition"};
        }

        public List<string> GetValues()
        {
            return new List<string>{m_BufferLength.ToString(), m_SamplingStepCount.ToString()};
        }
